...
if day == "friday" or day == "monday" or day == "tuesday" and time == "morning":
...
if day == "saturday" or day == "wednesday" and time == "morning":
...
if day == "sunday" or day == "thursday" and time == "morning":
